...
- **Додано панель налаштувань терміналу:** тепер можна змінювати шрифт, розмір, line height, стиль курсора, колір тексту/фону/виділення та всі 16 ANSI кольорів прямо в інтерфейсі програми — без перезбірки. Налаштування зберігаються в localStorage і застосовуються live до всіх SSH-сесій
