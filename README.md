...
*   **🔒 Безпека військового рівня (DPAPI)**:
    *   Паролі підключень **ніколи не зберігаються у відкритому вигляді** і не записуються у файл бази даних.
...
*   **📂 Гнучка база даних та імпорт/експорт**:
    ...
    *   Рідний експорт/імпорт у форматі JSON.
